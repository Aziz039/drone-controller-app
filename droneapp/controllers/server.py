'''
The server.py implements the Flask server, handling HTTP requests, managing routes, and interacting with the drone through the DroneManager

This is like the boss. It decides what happens when you click buttons or ask questions.
When you click buttons on the screen, this file decides what the drone should do. 
It also shows you live videos from the drone and makes sure everything runs smoothly.
'''
import logging
