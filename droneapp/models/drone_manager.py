'''
The DroneManager acts as the brain for controlling a drone, managing its movements, capturing images, and responding to commands.
It talks to the drone and tells it what to do.
'''
